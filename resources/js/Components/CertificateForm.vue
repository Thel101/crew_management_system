...
const form = useForm({
    name: props.certificate.name ? props.certificate.name : '',
    certificate_no: props.certificate.certificate_no ? props.certificate.certificate_no : '',
    issue_date: props.certificate.issue_date ? props.certificate.issue_date : '',
    expiry_date: props.certificate.expiry_date ? props.certificate.expiry_date : '',
    issuing_authority: props.certificate.issuing_authority ? props.certificate.issuing_authority : '',
    cert_image: ''
})
