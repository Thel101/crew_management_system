...
<template>
    ...
    <div
        class="sm:flex sm:justify-center sm:items-center min-h-screen bg-center bg-blue-900 selection:bg-red-500 selection:text-white">
            ...
            <div v-if="canLogin" class="p-6">
                ...
                <template v-else>
                    <div class="flex justify-between">
                        <button class="rounded-full bg-white px-10 py-3 hover:bg-blue-300">
